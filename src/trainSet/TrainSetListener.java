...
/**
 * TrainSetListener Class, extends Listener (see Listener)"
 */

public class TrainSetListener extends Listener {
	public TrainSetListener(FileManager fileManager) throws Exception {
		super(fileManager, FileType.TRAIN);
	}
}
